...
FEATURE_DIR="${PROJECT_ROOT}/artifacts/foundationalassist/features"
CHECKPOINT_DIR="${PROJECT_ROOT}/checkpoints/foundationalassist/context_target_slots_only"
RESULT_DIR="${PROJECT_ROOT}/results/foundationalassist/context_target_slots_only"
